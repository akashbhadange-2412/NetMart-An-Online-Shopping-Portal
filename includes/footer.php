...
<h3>Shopping Portal</h3>
     ...
     <div class="module-body m-t-20">
        <p class="about-us"> Your ultimate destination for seamless shopping experiences and endless choices. </p>
        ...
        <ul class="toggle-footer" style="">
            <li class="media">
                ...
                <div class="media-body">
                    <p>Warje Jakat Naka, Warje, Pune, Maharashtra 411052</p>
                </div>
            </li>
              ...
              <li class="media">
                ...
                <div class="media-body">
                    <p>(+91) 8605886685<br>(+91) 9096563752</p>
                </div>
            </li>
              ...
              <li class="media">
                ...
                <div class="media-body">
                    <span><a href="#">contact@netmart.in</a></span>
                </div>
            </li>
